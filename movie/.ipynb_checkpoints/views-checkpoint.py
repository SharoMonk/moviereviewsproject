...
def home(request):
    searchTerm = request.GET.get('searchMovie') # searchMovie is the name of the input field
    if searchTerm:
        movies = Movie.objects.filter(title__icontains=searchTerm) # case-insensitive
    else:
